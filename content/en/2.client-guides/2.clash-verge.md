...
seo:
  title: "Clash Verge Download & Installation Guide"
  description: "Install Clash Verge Rev on Windows, macOS, or Linux, then import a configuration and enable TUN mode or IPv6."
---
...
::tip
**⚠️ Important:**
Please note that `Clash Verge` is a proxy tool, not a proxy service provider. Installing it alone does not enable internet access. You need a [`how-choose-service (service provider)`](/en/installation-guide/quick-start) to get started. If you are unsure how to choose a provider, read [How to Choose the Right Provider↗](/en/installation-guide/quick-start).
::
