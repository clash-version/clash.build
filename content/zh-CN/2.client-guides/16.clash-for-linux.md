...
navigation: false
seo:
  title: "Clash Linux 安装教程"
  description: "使用 nelvko 脚本在 Ubuntu、Debian、CentOS、Arch 等 Linux 系统安装 Mihomo，并配置订阅、Web 面板和 TUN 模式。"
---
...
::note
该安装脚本本身不提供代理服务。继续操作前，请准备由可信服务提供方提供的订阅地址或配置文件。👉[戳我看看](https://iv.coolgo.me/aff.php?aff=35)
::
...
::tip
**⚠️提示：**
开启前请先阅读《[什么是TUN模式？](/zh-CN/installation-guide/advanced-settings)》
::
```bash
clashtun on          # 开启 Tun
clashtun off         # 关闭 Tun
...
### 替代客户端推荐
- [Clash Verge](/zh-CN/client-guides/clash-verge) - 跨平台现代 GUI 客户端，支持 Linux 桌面
- [FlClash](/zh-CN/client-guides/flclash) - Flutter 跨平台客户端，支持 Linux
- [Clash Mi](/zh-CN/client-guides/clashmi) - 轻量全平台客户端
- [Hiddify](/zh-CN/client-guides/hiddify) - 全平台通用客户端
- [查看所有客户端](/zh-CN/download)

### 快速入门指南
- [Clash 完整介绍](/zh-CN/installation-guide/quick-start) - 理解代理概念和术语
