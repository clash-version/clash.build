...
seo:
  title: "Clash Verge 下载与安装教程"
  description: "Clash Verge Rev 跨平台安装教程，介绍配置导入、TUN 模式和 IPv6 设置。"
---
...
::note
Clash Verge 本身不提供代理服务。继续操作前，请准备由可信服务提供方提供的订阅地址或配置文件。👉[戳我看看](https://iv.coolgo.me/aff.php?aff=35)
::
...
### 替代客户端推荐
- [FlClash](/zh-CN/client-guides/flclash) - 轻量级、资源占用少、跨平台
- [Hiddify](/zh-CN/client-guides/hiddify) - 全平台通用客户端、协议支持完整
- [Clash for Windows](/zh-CN/client-guides/clash-for-windows) - Windows经典客户端（已停更）
...
- [高级设置](/zh-CN/installation-guide/advanced-settings) - TUN模式、IPv6优化
...
- [TUN模式详解](/zh-CN/installation-guide/advanced-settings)
- [规则分流说明](/zh-CN/installation-guide/advanced-settings)

::tip
**💡 推荐阅读**
如果你是Clash新手，建议先阅读 [什么是Clash?](/zh-CN/installation-guide/quick-start) 了解核心概念，然后跟随 [快速开始指南](/zh-CN/installation-guide/quick-start) 进行实操。
::
