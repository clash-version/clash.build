...
seo:
  title: "鸿蒙系统使用卓易通安装Clash教程"
  description: "在 HarmonyOS 中通过卓易通安装 Clash Android 客户端，并完成订阅导入与代理开启。"
---

鸿蒙系统（HarmonyOS）用户想要使用Clash网络加速，除了使用原生鸿蒙应用[Clash Box](/zh-CN/client-guides/clash-box)外，还可以通过`卓易通安装Android版本的Clash客户端`。本教程将详细介绍如何使用卓易通在鸿蒙系统上安装和使用Clash。
...
::note
Clash 客户端本身不提供代理服务。继续操作前，请准备由可信服务提供方提供的订阅地址或配置文件。👉[戳我看看](https://iv.coolgo.me/aff.php?aff=35)
::
...
![Clash Meta for Android 订阅导入流程 1](/images/clash-meta-for-android/copy-install1.png)

![Clash Meta for Android 订阅导入流程 2](/images/clash-meta-for-android/copy-install2.png)

![Clash Meta for Android 订阅导入流程 3](/images/clash-meta-for-android/copy-install3.png)

![Clash Meta for Android 订阅导入流程 4](/images/clash-meta-for-android/copy-install4.png)

![Clash Meta for Android 订阅导入流程 5](/images/clash-meta-for-android/copy-install5.png)
::
...
- 点击开启代理即可
::div{.grid.gap-4.sm:grid-cols-2}
![Clash Meta for Android 订阅导入流程 1](/images/clash-meta-for-android/copy-install6.png)

![Clash Meta for Android 订阅导入流程 2](/images/clash-meta-for-android/copy-latest.png)
::
...
- [Clash Box 鸿蒙原生客户端教程](/zh-CN/client-guides/clash-box)
- [Clash Meta for Android 安装教程](/zh-CN/client-guides/clash-meta-for-android)
- [FlClash 全平台客户端教程](/zh-CN/client-guides/flclash)
- [如何选择适合自己的订阅](/zh-CN/installation-guide/quick-start)
